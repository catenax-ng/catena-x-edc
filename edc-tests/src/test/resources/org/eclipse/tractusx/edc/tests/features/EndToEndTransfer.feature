...
#The wrapper is to simplify the EDC interface
  # No contract negotiations

    # Extension on...
    # It should be available from the start in the new version from EDC
    # Same as Management API
    # Call Endpoint of ControlPlane Adapter