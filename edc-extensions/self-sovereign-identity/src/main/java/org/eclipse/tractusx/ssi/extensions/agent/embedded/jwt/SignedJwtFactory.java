...
import static org.eclipse.tractusx.ssi.extensions.agent.embedded.resolver.key.SigningMethod.SIGNING_METHOD_ES256;
...
public class SignedJwtFactory {
  ...
  public SignedJwtFactory(SsiAgentSettings settings, SigningKeyResolver signingKeyResolver) {
