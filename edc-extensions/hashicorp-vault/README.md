...
| edc.vault.hashicorp.health.check            | Enable checks to ensure vault is initialized, unsealed and active (default: _true_)                                                                                      ||
...
| edc.vault.hashicorp.api.health.path         | Path to the secret api (default: _/sys/health_)                                                                                                                          ||
